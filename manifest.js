...
const manifest = {
    ...
    registrations: [{
            ...
            plugin: {
                ...
                options: {
                    ...
                    models: {
                        ...
                        Assessment: './server/models/tbia_assessment',
                        Survey: './server/models/tbia_survey',
                        Response: './server/models/tbia_response',
        ...
        // TBI App Routes
        {
            plugin: './server/api/tbia_assessments',
        },

        {
            plugin: './server/api/tbia_surveys',
        },
